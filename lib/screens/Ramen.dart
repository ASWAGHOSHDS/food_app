              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                      image: AssetImage('asset/images/ramen.jpg') )
                ),
              ),
      Row(
        ...
        children: [
          ...
          Text("Ramen ",style: TextStyle(fontWeight: FontWeight.bold,
          fontSize: 30),),
          SizedBox(height: 10,),
          Padding(
            ...
            child: Container(
              child: const Column(
                children: [
                  ...
                  SizedBox(height:20,),
                  Text('Ramen is a Japanese noodle soup with thousands of variations. Most ramens are tonkotsu, made by boiling pork bones, pork fat, collagen, and other umami-rich ingredients like kombu (kelp), mushrooms, and katsuobushi (tuna flakes) for hours until its rich, creamy, and an absolute umami bomb.')
                ],
              ),
            ),
          ),
